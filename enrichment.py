...
def network_enrichment_scores(clustersfile):
...
pathwayenrichment, pathwaydistribution = network_enrichment_scores('non-metabolism network.pkl')
...
#PATHWAY COUNT STILL KEEPS THE COLUMN EVEN IF THE CLASSIFICAITON ISNT THERE 

#THAT FUCKS WITH THE R PLOT

#MAKE A WAY TO CHANGE IT? IDK 

with open('non-metabolism_pathwayenrichment','w') as f:
    json.dump(pathwayenrichment,f)

with open('non-metabolism_pathwaydistribution','w') as f:
...
def clusters_enrichment_scores(clustersfile):
    ...
    pathwaycount = pathway_count(clusters)
    pathwayenrichment = pathway_enrichment_all(clusters)
    pathwaydistribution = distribution(pathwaycount)

    return pathwayenrichment, pathwaydistribution
    

#pathwayenrichment, pathwaydistribution = clusters_enrichment_scores('pamlist.json')

#with open('pathwayenrichment','w') as f:
    json.dump(pathwayenrichment,f)

#with open('pathwaydistribution','w') as f:
    json.dump(pathwaydistribution,f)